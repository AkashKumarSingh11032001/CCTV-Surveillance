...
window = tk.Tk()
window.title("CCTV")
window.iconphoto(False, tk.PhotoImage(file='F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/mn.png'))
...
icon = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/spy.png')
icon = icon.resize((150,150), Image.ANTIALIAS)
icon = ImageTk.PhotoImage(icon)
label_icon = tk.Label(frame1, image=icon)
label_icon.grid(row=1, pady=(5,10), column=2)

btn1_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/lamp.jpg')
btn1_image = btn1_image.resize((50,50), Image.ANTIALIAS)
btn1_image = ImageTk.PhotoImage(btn1_image)

btn2_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/mark.png')
btn2_image = btn2_image.resize((50,50), Image.ANTIALIAS)
btn2_image = ImageTk.PhotoImage(btn2_image)

btn5_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/exit.png')
btn5_image = btn5_image.resize((50,50), Image.ANTIALIAS)
btn5_image = ImageTk.PhotoImage(btn5_image)

btn3_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/security-camera.png')
btn3_image = btn3_image.resize((50,50), Image.ANTIALIAS)
btn3_image = ImageTk.PhotoImage(btn3_image)

btn6_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/incognito.png')
btn6_image = btn6_image.resize((50,50), Image.ANTIALIAS)
btn6_image = ImageTk.PhotoImage(btn6_image)

btn4_image = Image.open('F:/Rough/smart-cctv-tkinter-master-20210714T112842Z-001/smart-cctv-tkinter-master/icons/record.png')
